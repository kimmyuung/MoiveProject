		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" onclick="cancel()">취소
						요청</button>
					<button type="button" class="btn btn-primary" onclick="cancel()">반품
						요청</button>
					<button type="button" class="btn btn-primary" onclick="cancel()">교환
						요청</button>
