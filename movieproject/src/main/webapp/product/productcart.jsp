...
<link href="/movieproject/css/productcart.css" rel="stylesheet">
</head>
<body>
	...
	<%@include file = "../header.jsp" %>
		<div class="container"> <!-- container(b) : 컨테이너  -->
			...
			<div class="row my-5"> <!-- 부트스트랩만 사용되는 구역  -->
				...
				<div class="col-sm-3">
					<a href="/movieproject/product/orderpay.jsp">
	...
	<script type="text/javascript" src="/movieproject/js/productcart.js"></script>
